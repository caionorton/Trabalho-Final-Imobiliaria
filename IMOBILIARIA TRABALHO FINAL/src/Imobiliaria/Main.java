...
public class Main {
    ...
    private static void cadastrarClienteProprietario(Scanner sc, List<ClienteProprietario> proprietarios) {
        ...
        int qtdTelefones = Integer.parseInt(sc.nextLine());
    ...
    private static void cadastrarClienteUsuario(Scanner sc, List<ClienteUsuario> usuarios) {
        ...
        do {
            ...
            qtdFiadores = Integer.parseInt(sc.nextLine());
        } while (qtdFiadores < 1);
        ...
        do {
            ...
            qtdIndicacoes = Integer.parseInt(sc.nextLine());
    ...
    private static void cadastrarFuncionario(Scanner sc, List<Funcionario> funcionarios) {
        ...
        double salarioBase = Double.parseDouble(sc.nextLine().replace(",", "."));
        System.out.print("Percentual de comissao (ex 0.05 para 5%): ");
        double percentualComissao = Double.parseDouble(sc.nextLine().replace(",", "."));
    ...
    private static void cadastrarImovel(Scanner sc, List<Imovel> imoveis) {
        ...
        if (tipo == 1) {
            ...
            double valorCondominio = Double.parseDouble(sc.nextLine().replace(",", "."));
            ...
            double largura = Double.parseDouble(sc.nextLine().replace(",", "."));
            System.out.print("Comprimento: ");
            double comprimento = Double.parseDouble(sc.nextLine().replace(",", "."));
            ...
            int qtdBanheiros = Integer.parseInt(sc.nextLine());
            System.out.print("Quantidade de comodos: ");
            int qtdComodos = Integer.parseInt(sc.nextLine());
    ...
    private static void realizarTransacao(Scanner sc,
        ...
        double valorReal = Double.parseDouble(sc.nextLine().replace(",", "."));
    ...
    private static FormaPagamento escolherFormaPagamento(Scanner sc) {
        ...
        System.out.println("1-DINHEIRO 2-PIX 3-CARTAO 4-BOLETO 5-TRANSFERENCIA");
        System.out.print("Escolha: ");
        int opcao = Integer.parseInt(sc.nextLine());
        if (opcao == 1) {
